            ...
            <AnimateIn>
              <div className="relative bg-navy rounded-3xl p-10 lg:p-14 h-full flex flex-col text-white overflow-hidden group hover:shadow-2xl transition-shadow">
                ...
                <div className="relative z-10 flex flex-col h-full">
                  <div className="w-16 h-16 bg-red rounded-2xl flex items-center justify-center mb-8 shadow-[0_4px_20px_rgba(204,0,0,0.3)]">
                    <span className="font-bold text-xl font-[var(--font-chakra)]">
                      IC
                    </span>
                  </div>
                  ...
                  <h3 className="text-3xl lg:text-4xl font-bold uppercase tracking-tight mb-5 font-[var(--font-chakra)] leading-[0.95]">
                    Inspire Courts
                  </h3>
            ...
            <AnimateIn delay={150}>
              <div className="relative bg-white border-2 border-light-gray rounded-3xl p-10 lg:p-14 h-full flex flex-col overflow-hidden group hover:border-red/40 hover:shadow-2xl transition-all">
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <h3 className="text-3xl lg:text-4xl font-bold uppercase tracking-tight text-navy mb-5 font-[var(--font-chakra)] leading-[0.95]">
                    OFF SZN HOOPS
                  </h3>
            ...
            {[
              ...
              <AnimateIn key={stat.label} delay={i * 100}>
                <div className="text-center">
                  <div className="text-5xl md:text-7xl lg:text-8xl font-bold text-red font-[var(--font-chakra)] leading-none drop-shadow-[0_0_30px_rgba(204,0,0,0.25)]">
                    {stat.num}
                  </div>
                  <div className="text-xs md:text-sm text-white/50 uppercase tracking-[0.2em] mt-4 font-semibold font-[var(--font-chakra)]">
                    {stat.label}
                  </div>
                </div>
              </AnimateIn>
