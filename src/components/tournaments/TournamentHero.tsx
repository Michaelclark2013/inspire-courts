    ...
    <section className="relative overflow-hidden" aria-label="Tournament registration hero">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 py-20 lg:py-28 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            href="/scores"
            className="inline-flex items-center gap-2 bg-white/10 border-2 border-white/30 hover:bg-white/20 text-white px-8 py-4 rounded-full font-bold text-sm uppercase tracking-wide transition-colors font-heading focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-navy min-h-[48px]"
          >
            Live Scores
          </Link>
        </div>
