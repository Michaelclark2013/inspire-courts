...
const GALLERY_ITEMS = [
  { id: 1, category: "Tournaments", color: "from-red/20 to-red/5" },
  { id: 2, category: "Facility", color: "from-navy/20 to-navy/5" },
  { id: 3, category: "Highlights", color: "from-green-500/20 to-green-500/5" },
  { id: 4, category: "Tournaments", color: "from-purple-500/20 to-purple-500/5" },
  { id: 5, category: "Facility", color: "from-red/20 to-red/5" },
  { id: 6, category: "Highlights", color: "from-red-500/20 to-red-500/5" },
  { id: 7, category: "Tournaments", color: "from-yellow-500/20 to-yellow-500/5" },
  { id: 8, category: "Facility", color: "from-teal-500/20 to-teal-500/5" },
  { id: 9, category: "Highlights", color: "from-red/20 to-red/5" },
];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-32 lg:py-40">
          <AnimateIn>
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto leading-relaxed">
              Game action, facility shots, and tournament highlights.
            </p>
          </AnimateIn>
        </div>
      </section>
