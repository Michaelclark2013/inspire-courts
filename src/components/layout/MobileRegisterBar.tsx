...
export default function MobileRegisterBar() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden bg-white/95 backdrop-blur-md border-t border-light-gray p-3 shadow-[0_-4px_20px_rgba(0,0,0,0.1)]" role="complementary" aria-label="Tournament registration">
      <a
