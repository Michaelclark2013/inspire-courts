  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "We host basketball, volleyball, futsal, and jiu-jitsu. Our courts can be configured for the sport you need. Email us or fill out the booking form with your sport and we'll set you up.",
      },
    ],
  },
  {
  ...
  return (
    <>
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-28 pb-16 sm:py-28 lg:py-36">
          <AnimateIn>
