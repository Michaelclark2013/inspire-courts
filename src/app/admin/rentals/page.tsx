...
export default function RentalsListPage() {
  ...
  return (
    <main className="bg-off-white min-h-screen p-4 sm:p-6 lg:p-8">
      ...
      <div className="bg-white border border-border rounded-2xl p-3 mb-4 flex items-center gap-2 overflow-x-auto no-scrollbar">
      ...
      {loading ? (
        ...
        <div className="bg-white border border-border rounded-2xl shadow-sm overflow-hidden">
          <ul className="divide-y divide-border">
            {rows.map(({ booking, vehicleName, vehiclePlate }) => (
              <li key={booking.id}>
                <Link
