      ...
      <div className="relative w-full max-w-sm z-10">
        ...
        >
          ...
          <div className="space-y-3 mb-6">
            ...
            <button
              type="button"
              onClick={() => signIn("apple", { callbackUrl: "/login" })}
              className="flex items-center justify-center gap-3 w-full bg-black hover:bg-gray-900 text-white py-3.5 rounded-lg font-semibold text-sm transition-all border border-white/10"
            >
