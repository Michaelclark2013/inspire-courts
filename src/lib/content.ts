      ...
      sections: [
        ...
        },
        {
          ...
          list: {
            ...
            items: [
              ...
              { title: "Snack Bar", description: "Drinks, snacks, and game-day fuel available all day. Outside food welcome, no glass." },
              { title: "Free Parking", description: "Always free. No meters, no permits, no cost. If someone asks you to pay, it's not us." },
            ],
          },
        },
        {
        ...
        },
        {
          ...
          fields: {
            ...
            parkingNote: { label: "Parking Note", value: "FREE Parking — Always", type: "text" },
        ...
        },
        {
          ...
          list: {
            ...
            items: [
              ...
              { eyebrow: "Concessions", title: "Snack Bar & Game-Day Fuel", description: "Drinks, snacks, and meals available all day. Outside food is allowed. No glass bottles." },
              { eyebrow: "Climate", title: "Fully Air-Conditioned", description: "No Arizona heat, no excuses. Fully climate-controlled year-round." },
              { eyebrow: "Parking", title: "FREE Parking — Always", description: "Free parking for every visitor, every event. No meters, no permits, no cost." },
            ],
          },
        },
        {
      ...
      sections: [
        ...
        },
        {
          ...
          fields: {
            ...
            parking: { label: "Parking", value: "FREE PARKING — no cost, no meters, no permits.", type: "text" },
            ...
            food: { label: "Food", value: "Snack bar is open all day. Outside food allowed. No glass bottles.", type: "text" },
